...
// 데모 고정 신원: 고객 = Jacob Ea / 워커 = Sari Dewi
export const CUSTOMER_ME: ChatParticipant = { id: 'cust-me', name: 'Jacob Ea', photo: SEONGKI_PHOTO, role: 'customer' };
...
// ── 시드 대화 ──────────────────────────────────────────────────
//  메인:  Jacob Ea(고객) ↔ Sari Dewi(워커)  — 양쪽 기기에서 보임
